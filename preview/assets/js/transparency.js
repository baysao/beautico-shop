  ...
  1: [function (require, module, exports) {
    ...
    Element = (function () {
      function Element(el1) {
        ...
        rawClass = typeof this.el.className === 'string' ? this.el.className : (this.el.className && typeof this.el.className.baseVal === 'string' ? this.el.className.baseVal : '');
        this.classNames = rawClass ? rawClass.split(' ') : [];
